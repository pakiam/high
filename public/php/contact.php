...
if(trim($name) == '') {
	...
	echo '<div class="error_message">Пожалуйста, введите ваш e-mail!</div>';
	exit();
} else if(trim($phone) == '') {
	...
	echo '<div class="error_message">Вы ввели неверный e-mail.</div>';
	exit();
}
...
$e_subject = $name . ' написал вам с сайта Bow Strategy .';
